...
def test_chapps_grl_first_attempt_denied(caplog,
                                         clear_redis_grl,
                                         chapps_grl_service,
                                         known_sender,
                                         grl_test_recipients,
    ...
    message = grl_test_message_factory( known_sender,
                                        grl_test_recipients,)
...
def test_chapps_grl_acceptance_after_deferral(caplog,
...
def test_chapps_grl_accept_emails_from_proven_clients(caplog,
