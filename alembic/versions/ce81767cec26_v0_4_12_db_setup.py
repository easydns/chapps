...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['domain_id'], ['domains.id'], name=op.f('fk_domain_user_domain_id_domains'), onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_domain_user_user_id_users'), onupdate='RESTRICT', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('user_id', 'domain_id', name=op.f('pk_domain_user'))
    )
    op.create_table('email_user',
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('email_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['email_id'], ['emails.id'], name=op.f('fk_email_user_email_id_emails'), onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_email_user_user_id_users'), onupdate='RESTRICT', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('user_id', 'email_id', name=op.f('pk_email_user'))
    )
    op.create_table('quota_user',
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('quota_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['quota_id'], ['quotas.id'], name=op.f('fk_quota_user_quota_id_quotas'), onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_quota_user_user_id_users'), onupdate='RESTRICT', ondelete='CASCADE'),
