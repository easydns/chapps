...
TODO: some of the 'API' code, mainly the data models and database access
logic, needs to migrate into the main package.  Since access to the database is
already isolated into the adapter classes, this should not be too tough to do.
