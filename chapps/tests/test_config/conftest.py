...
def chapps_mock_config():
    ...
    cp['GreylistingPolicy'] = { 'rejection_message': 'DEFER_IF_PERMIT Service temporarily stupid' }
...
def chapps_sentinel_config_file( chapps_sentinel_config, chapps_sentinel_cfg_path ):
    yield from _chapps_mock_config_file( chapps_sentinel_config, chapps_sentinel_cfg_path )
